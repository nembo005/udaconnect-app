...
## Project structure
- db/ folder contains the database input
- scripts/ folder contains instructions to instanciate the database
* deployment/ folder has kubernetes deployment and services settings 
...
* modules/ folder has all the codes and the dockerfiles
